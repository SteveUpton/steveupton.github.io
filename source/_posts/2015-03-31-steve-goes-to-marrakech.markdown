---
layout: post
title: "Steve goes to Marrakech"
date: 2015-03-31 21:55:00 +0100
comments: true
categories: 
tags: travel
---

A few weeks ago, I travelled from London to Marrakech by train (and boat). Like with my [Moscow to Shanghai trip]({% post_url 2014-08-24-whisky-in-the-gobi %}), I kept a travel diary and have once again reproduced it in blog form. As before, each entry is reproduced as it was written on the day it describes, during or shortly after the moment (bar spelling/grammatical fixes). Read it with your eyes.

<!-- more -->

## Day 1

{% img /images/posts/sgtm-day1.jpg %}
...
{% img /images/posts/sgtm-day2.jpg %}
...
{% img /images/posts/sgtm-day3.jpg %}
...
{% img /images/posts/sgtm-day4.jpg %}
...
{% img /images/posts/sgtm-day5.jpg %}
...
{% img /images/posts/sgtm-day6.jpg %}
...
{% img /images/posts/sgtm-day7.jpg %}
...
{% img /images/posts/sgtm-day8.jpg %}
...
{% img /images/posts/sgtm-day9.jpg %}
...
{% img /images/posts/sgtm-day10.jpg %}
